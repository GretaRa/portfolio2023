...
const Skills = () => {
	return (
		<div className="flex flex-col lg:flex-row items-center lg:mx-[15%] justify-start mx-[10%] gap-5 lg:gap-16">
			<span className="text-xl">Tech&nbsp;stack&nbsp;|</span>
			<div className="grid grid-cols-3 lg:flex justify-start items-center lg:gap-16 md:gap-7 gap-5 lg:text-xl ">
